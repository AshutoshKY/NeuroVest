...
2. **operation_logs**
   - Track every scrape, API call, analysis
   - Performance metrics (duration_ms)
   - Error tracking

3. **data_source_status**
   - Monitor health of scrapers & APIs
   - Success rates
...
|-----|-----------|-----------|-----------------|
| Azure OpenAI (GPT-4) | None | $0.03/1K tokens | ~500 tokens/analysis |
| Azure OpenAI (Embedding) | None | $0.0001/1K tokens | ~200 tokens/article |
| Finnhub | 60 calls/min | $99/month | 1 call/stock query |
| Alpha Vantage | 5 calls/min | $50/month | 1 call/stock query |
| Yahoo Finance | Unlimited | Free | 1 call/stock query |
| Marketstack | 100 calls/month | $10/month | Rarely used |
